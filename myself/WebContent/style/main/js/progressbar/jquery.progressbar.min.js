...
(function ($) {
	var imagePath="style/main/js/progressbar/images";
	$.extend({progressBar:new function () {
		this.defaults = {steps:20, stepDuration:20, max:100, showText:true, textFormat:"percentage", width:120, height:12, callback:null, boxImage:imagePath+"/progressbar.gif", barImage:{0:imagePath+"/progressbg_red.gif", 30:imagePath+"/progressbg_orange.gif", 70:imagePath+"/progressbg_green.gif"}, running_value:0, value:0, image:null};
