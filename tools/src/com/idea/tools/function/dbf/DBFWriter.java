...
public class DBFWriter extends DBFBase {
	...
	*/
	 ...
	 * @param recordsNums
	 */
	public DBFWriter(int recordsNums){
		this.recordsNums = recordsNums;
		this.header = new DBFHeader();
	}
	...
	*/
	...
	/**
	 * add a records Modify by chenzg
	 * @param values
	 * @param out
	 * @throws DBFException
	 */
	public void addRecord( Object[] values,DataOutputStream outStream)
	throws DBFException {
	 ...
	 * @throws DBFException
	 */
	public void writeHeader(DataOutputStream outStream) throws DBFException{
		
		try {
			this.header.numberOfRecords = recordsNums;
	 ...
	 * @throws DBFException
	 */
	public void writeEnd(DataOutputStream outStream) throws DBFException{
		try {
