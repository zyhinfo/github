...
public class DBFField {
	...
	*/
	...
	throws IOException {
		...
		sb.append("fieldName：").append(new String(fieldName)).append("\n");
		sb.append("new byte[ 11 - fieldName.length]：").append(11 - fieldName.length).append("\n");
		sb.append("dataType：").append(dataType).append("\n");
		sb.append("0x00：").append(0x00).append("\n");
